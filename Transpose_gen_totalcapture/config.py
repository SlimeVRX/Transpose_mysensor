...
class paths:
    ...
    raw_totalcapture_dip_dir = '../acc2pos/TotalCapture/TotalCapture_Real_WS5'

    raw_totalcapture_official_dir = '../acc2pos/TotalCapture/s1_vicon_pos_ori.tar/s1_vicon_pos_ori'
