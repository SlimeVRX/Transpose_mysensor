...
def process_amass(smooth_n=4):
    ...
    def _syn_acc(v):
        ...
        return acc
    # hello world!
    # IMU wearing position
    # # head 198 - 411 - head
    # # crotch 3026 - 3021 - root
    # # Right hand 5425 - 5424 - rarm
    # # Left Hand 1970 - 1961 - larm
    # # left foot 1372 - 1176 - lleg
    # # right foot 4845 - 4662 - rleg
    ...
    for ds_name in amass_data:
        ...
        # try: cdata = np.load("D:/Xu/test_transpose/source/AMASS/ACCAD/ACCAD/s011/walkdog_stageii.npz")
        try: cdata = np.load("../acc2pos/AMASS/dataset/s011/walkdog_poses.npz")
        except: continue
